...
const CartPage = () => {
  return (
    ...
    <div className="hidden sm:block">
      <div className="relative p-20 pt-5 pb-5">
      <div className="flex flex-col md:flex-row items-start gap-8 bg-white rounded-lg ">
  {/* Back Button */}
  ...
  <span className="ml-2">Back</span>
    ...
    {/* Main Content */}
    <h1 className="text-4xl font-goudy text-gray-900 mb-4">Get Fit & Fierce</h1>
    <p className="text-[#4E4E4E] pr-10 mb-6">
    ...
    {/* Links */}
    <div className="space-y-8 w-3/4 p-20 pl-0 pt-5">
  ...
  <div className="w-full md:w-2/4">
    <img
      src="../assets/wellness2.png"
      alt="Avocado dish"
      className="rounded-3xl shadow-md object-cover w-full h-[600px]"
    />
  </div>
      </div>
      </div>
  ...
  <hr className="border-t border-gray-600" />
      ...
      <div className="flex h-screen overflow-hidden p-20 pt-0">
              ...
              {/* Fixed Right Section */}
              <div className="pt-10  pb-20  w-[500px] h-[600px]">
  ...
  <hr className="border-t border-gray-600" />
      ...
      <h2 className="text-2xl p-5  text-[#1E1E1E] font-goudy pl-20">Relevant Retreat</h2>
      <div className="flex overflow-x-auto w-full scrollbar-hide p-20 pb-10 pt-5">
  <div className="flex space-x-4 justify-between w-full">
    <div className="bg-white rounded-lg w-[90%] sm:w-[90%] md:w-[30%] min-w-[300px] flex-shrink-0">
    ...
    <div className="bg-white rounded-lg w-[90%] sm:w-[90%] md:w-[30%] min-w-[300px] flex-shrink-0">
      ...
      <h2 className="text-2xl p-5  text-[#1E1E1E] font-goudy pl-20">Relevant Wisdom</h2>
      <div className="flex overflow-x-auto scrollbar-hide p-20 pt-5 pb-5 space-x-4 justify-between">
